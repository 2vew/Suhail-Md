...
global.sudo = process.env.SUDO ? process.env.SUDO.replace(/[\s+]/g, '') : "2349067307100";
global.owner= process.env.OWNER_NUMBER ? process.env.OWNER_NUMBER.replace(/[\s+]/g, '') : "2349067307100";
...
global.readmessagefrom = process.env.READ_MESSAGE_FROM || "2349067307100,234xxxxxxxx";


//========================= [ AUTO SAVE & READ STATUS ] =========================\\
global.read_status = process.env.AUTO_READ_STATUS || "false"
global.save_status = process.env.AUTO_SAVE_STATUS || "false"
global.save_status_from =  process.env.SAVE_STATUS_FROM  || "2349067307100,234xxxxxxxx";
global.read_status_from =  process.env.READ_STATUS_FROM  ||  "2349067307100,234xxxxxxxx";
